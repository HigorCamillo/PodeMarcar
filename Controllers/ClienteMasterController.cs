                ...
                if (response.IsConnected)
                {
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(appResponse.AppKey) && 
                            !string.IsNullOrWhiteSpace(appResponse.AuthKey))
                        {
                            // Chaves obtidas com sucesso! Salva no banco.
                            cliente.AppKey = appResponse.AppKey;
                            cliente.AuthKey = appResponse.AuthKey;
                        ...
                        else
                        {
                            ...
                            _logger.LogWarning($"Falha ao obter chaves ativamente para Cliente={id}. Resposta: {appResponse.Message}");
