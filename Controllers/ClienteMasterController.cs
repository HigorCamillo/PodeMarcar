            ...
            try
            {
                ...
                if (response.IsConnected)
                {
                    ...
                    else
                    {
                        ...
                        _logger.LogInformation($"Dispositivo conectado mas chaves ainda não recebidas para Cliente={id}");
                        
                        return Ok(new
                        {
                            Connected = true,
                            Message = "Dispositivo conectado. Aguardando recebimento das chaves..."
                        });
                    }
                }
